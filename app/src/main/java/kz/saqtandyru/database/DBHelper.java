package kz.saqtandyru.database;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String CARS_COLUMN_YEAR = "rok";
    private static final String CARS_COLUMN_POJEMNOSC = "pojemnosc";
    private static final String CARS_COLUMN_POWER = "moc";
    private static final String CARS_COLUMN_ICON = "ikona";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + CARS_TABLE_NAME + " (" +
                ...
                CARS_COLUMN_YEAR + " TEXT NOT NULL, " +
                CARS_COLUMN_POJEMNOSC + " TEXT NOT NULL, " +
                CARS_COLUMN_POWER + " TEXT NOT NULL, " +
                CARS_COLUMN_ICON + " INTEGER NOT NULL, " +
